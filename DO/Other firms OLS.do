...
test (or11–10 = 0) (or09–08 = 0) /// 
(or10 = 0) (ne10 = 0) /// 
(ne11–10 = 0) (manu_paper_dummy = 0) /// 
(manu_chemicals_dummy = 0) (manu_other_dummy = 0) ///
(electricity_dummy = 0) (gas_and_steam_dummy = 0)

// On significant variables
regress or12–11 /// 
af12 /// 
or10–09 mining_dummy ///
manu_metal_dummy, robust
...
// Test: Excluding insignificant variables 
test (ne11–10 = 0) (ne10–09 = 0) ///
(mining_dummy = 0) (manu_paper_dummy = 0) /// 
(manu_chemicals_dummy = 0) (manu_metal_dummy = 0) /// 
